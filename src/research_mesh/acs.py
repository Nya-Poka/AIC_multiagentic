...
AGENT_CARDS: dict[str, AgentCardDefinition] = {
    "leader": AgentCardDefinition(
        ...
        description=(
            "面向科研人员的一站式科研助理与多智能体协作平台。根据研究问题"
            "动态编排可追溯文献检索、实验设计、证据与数据分析、统计摘要及方法"
            "规范复核，输出包含来源证据和过程记录的结构化科研报告；不替代伦理"
            "审批或高风险研究决策。"
        ),
        skill_id="research-collaboration.orchestration",
        skill_name="一站式科研助理与多智能体科研协作编排",
        skill_description=(
            "接收科研问题、研究目标、数据和约束，动态组织文献检索、实验设计、"
            "数据分析、统计分析和规范复核智能体，生成可追溯的一站式科研报告。"
        ),
        tags=(
            "一站式科研助理",
            "科研协作",
        ...
        examples=(
            "帮我检索相关文献并设计一项可复现的科研实验",
            "围绕睡眠时长与学习表现完成文献检索、实验设计和数据分析",
            "分析我提供的研究数据并生成统计摘要和研究报告",
            "检查这份研究方案的证据来源、实验控制和方法规范",
            "组织多个科研智能体协作完成从文献检索到规范复核的全过程",
        ),
    ),
